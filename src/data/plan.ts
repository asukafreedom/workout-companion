...
export const EXERCISES: Exercise[] = [
  // ---------- Upper Body A (Monday) ----------
  {
    ...
    primary: ['pecs'], secondary: ['deltFront', 'triceps'],
    hints: [{kind: 'arc',points: [[0,1.3,0.15],[0,1.32,0.35],[0,1.34,0.5]]}],
  ...
  },
  {
    ...
    primary: ['pecs'], secondary: ['deltFront', 'triceps'],
    hints: [{kind: 'arc',points: [[0.2,1.3,0.15],[0.12,1.32,0.35],[0.05,1.34,0.5]]}],
  ...
  },
  {
    ...
    primary: ['lats'], secondary: ['biceps', 'midBack'],
    hints: [{kind: 'arrow',points: [[0.22,1.85,0.1],[0.22,1.4,0.12]]}],
  ...
  },
  {
    ...
    sets: 3, repMin: 8, repMax: 12, loadType: 'machine', restSec: 90,
    primary: ['midBack', 'lats'], secondary: ['biceps', 'deltRear'],
    hints: [{kind: 'arrow',points: [[0.12,1.15,0.55],[0.12,1.12,0.15]]}],
  ...
  },
  {
    ...
    primary: ['deltFront', 'deltSide'], secondary: ['triceps'],
    hints: [{kind: 'arc',points: [[0.26,1.5,0.05],[0.22,1.75,0.03],[0.1,1.95,0]]}],
  ...
  },
  {
    ...
    primary: ['deltSide'], secondary: ['traps'],
    hints: [{kind: 'arc',points: [[0.28,0.95,0.05],[0.45,1.2,0.03],[0.55,1.45,0]]}],
  ...
  },
  {
    ...
    hints: [{kind: 'arrow',points: [[0.28,1.25,0.2],[0.28,0.95,0.18]]}],
  ...
  },
  {
    ...
    hints: [{kind: 'arc',points: [[0.28,0.9,0.1],[0.33,1.1,0.25],[0.3,1.3,0.3]]}],
  ...
  // ---------- Lower Body A (Tuesday) ----------
  {
    ...
    sets: 3, repMin: 6, repMax: 10, loadType: 'total', restSec: 120,
    primary: ['quads', 'glutes'], secondary: ['erectors', 'adductors'],
    hints: [{kind: 'arrow',points: [[0,1.5,-0.1],[0,1,-0.1]]}],
  ...
  },
  {
    ...
    hints: [{kind: 'arrow',points: [[0.13,0.55,0.25],[0.13,0.5,0.55]]}],
  ...
  },
  {
    ...
    hints: [{kind: 'arc',points: [[0,0.5,0.14],[0,0.72,0.15],[0,0.95,0.14]]}],
  ...
  },
  {
    ...
    hints: [{kind: 'arrow',points: [[0.15,0.95,0.1],[0.15,0.55,0.1]]}],
  ...
  },
  {
    ...
    hints: [{kind: 'arc',points: [[0.13,0.15,-0.15],[0.13,0.35,-0.4],[0.13,0.65,-0.5]]}],
  ...
  },
  {
    ...
    hints: [{kind: 'arrow',points: [[0.13,0.05,-0.08],[0.13,0.35,-0.08]]}],
  ...
  },
  {
    ...
    hints: [{kind: 'arc',points: [[0,1.55,0.15],[0,1.3,0.3],[0,1.05,0.35]]}],
  ...
  // ---------- Upper Body B (Thursday) ----------
  {
    ...
    sets: 3, repMin: 8, repMax: 12, loadType: 'dumbbell', restSec: 120,
    primary: ['pecs', 'deltFront'], secondary: ['triceps'],
    hints: [{kind: 'arc',points: [[0.18,1.35,0.15],[0.1,1.55,0.35],[0.04,1.7,0.45]]}],
  ...
  },
  {
    ...
    primary: ['lats'], secondary: ['biceps', 'midBack'],
    hints: [{kind: 'arrow',points: [[0.35,1,0],[0.35,1.45,0]]}],
  ...
  },
  {
    ...
    sets: 3, repMin: 8, repMax: 12, loadType: 'machine', restSec: 90,
    primary: ['midBack'], secondary: ['lats', 'biceps', 'deltRear'],
    hints: [{kind: 'arrow',points: [[0.15,1.25,0.5],[0.15,1.28,0.15]]}],
  ...
  },
  {
    ...
    sets: 3, repMin: 10, repMax: 15, loadType: 'machine', restSec: 90,
    primary: ['pecs'], secondary: ['deltFront'],
    hints: [{kind: 'arc',points: [[0.5,1.32,0.1],[0.28,1.33,0.32],[0.05,1.34,0.42]]}],
  ...
  },
  {
    ...
    sets: 3, repMin: 12, repMax: 20, loadType: 'dumbbell', restSec: 90,
    primary: ['deltRear'], secondary: ['midBack', 'traps'],
    hints: [{kind: 'arc',points: [[0.2,1.3,0.3],[0.45,1.35,0.05],[0.55,1.38,-0.15]]}],
  ...
  },
  {
    ...
    sets: 3, repMin: 10, repMax: 15, loadType: 'dumbbell', restSec: 90,
    primary: ['triceps'], secondary: [],
    hints: [{kind: 'arc',points: [[0.08,1.55,-0.15],[0.1,1.8,-0.08],[0.08,2,0.02]]}],
  ...
  // ---------- Lower Body B (Saturday) ----------
  {
    ...
    primary: ['glutes', 'hamstrings', 'quads'], secondary: ['erectors', 'traps', 'forearms'],
    hints: [{kind: 'arrow',points: [[0.15,0.35,0.1],[0.15,0.95,0.1]]}],
  ...
  },
  {
    ...
    hints: [{kind: 'arrow',points: [[0,1.45,-0.12],[0,0.95,-0.12]]}],
  ...
  },
  {
    ...
    hints: [{kind: 'arrow',points: [[0,0.95,0.1],[0,0.9,0.5]]}],
  ...
  },
  {
    ...
    hints: [{kind: 'arc',points: [[0,0.55,0.1],[0,0.8,0.28],[0,1,0.32]]}],
