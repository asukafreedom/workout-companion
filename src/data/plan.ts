...
export const EXERCISES: Exercise[] = [
  // ---------- Upper Body A (Monday) ----------
  {
    ...
    hints: [{ kind: 'arc', points: [[0.44, 1.15, 0.08], [0.42, 1.45, 0.04], [0.38, 1.75, 0]] }],
  ...
  },
  {
    ...
    primary: ['pecs'], secondary: ['deltFront', 'triceps'], pose: 'lying',
    hints: [{ kind: 'arc', points: [[0.44, 1.15, 0.2], [0.4, 1.45, 0.15], [0.34, 1.75, 0.05]] }],
  ...
  },
  {
    ...
    hints: [{ kind: 'arrow', points: [[0.2, 1.9, 0.12], [0.2, 1.3, 0.12]] }],
  ...
  },
  {
    ...
    hints: [{ kind: 'arc', points: [[0.225, 1.07, 0.05], [0.18, 1.35, 0.03], [0.08, 1.6, 0]] }],
  ...
  },
  {
    ...
    hints: [{ kind: 'arc', points: [[0, 0.95, 0.28], [0, 0.65, 0.32], [0, 0.35, 0.22]] }],
  ...
  },
  {
    ...
    hints: [{ kind: 'arc', points: [[-0.85, 0.95, 0.1], [-0.6, 1.25, 0.08], [-0.15, 1.0, 0.05]] }],
  ...
  },
  {
    ...
    hints: [{ kind: 'arrow', points: [[0.13, 0.05, 0.08], [0.13, 0.32, 0.08]] }],
  ...
  },
  {
    ...
    hints: [{ kind: 'arc', points: [[0, 1.5, 0.15], [0, 1.15, 0.22], [0, 0.8, 0.28]] }],
  ...
  // ---------- Upper Body B (Thursday) ----------
  {
    ...
    hints: [{ kind: 'arc', points: [[0.1, 1.1, -0.43], [0.1, 1.19, -0.28], [0.1, 1.3, -0.1]] }],
  ...
  },
  {
    ...
    hints: [{ kind: 'arrow', points: [[0, 0.85, 0.22], [0, 1.55, 0.15]] }],
  ...
  },
  {
    ...
    hints: [{ kind: 'arrow', points: [[0.065, 1.13, -0.37], [0.065, 0.95, -0.67]] }],
  ...
  },
  {
    ...
    hints: [{ kind: 'arc', points: [[0.2, 1.0, 0.23], [0.4, 1.2, 0.1], [0.58, 1.34, -0.03]] }],
  ...
  },
  {
    ...
    hints: [{ kind: 'arc', points: [[0.1, 1.15, -0.15], [0.12, 1.45, -0.05], [0.1, 1.7, 0.05]] }],
  ...
  // ---------- Lower Body B (Saturday) ----------
  {
    ...
    hints: [{ kind: 'arrow', points: [[0.2, 0.35, 0.15], [0.2, 1.05, 0.15]] }],
